...
namespace Microsoft.AspNetCore.Mvc.Razor.Internal
{
    public static class MvcRazorLoggerExtensions
    {
        ...
        private static readonly Action<ILogger, string[], Exception> _viewCompilerLocatedCompiledViews;
        ...
        static MvcRazorLoggerExtensions()
        {
            ...
            _viewCompilerLocatedCompiledViews = LoggerMessage.Define<string[]>(
                LogLevel.Debug,
                3,
                "Initializing Razor view compiler with the following compiled views: ('{ViewNames}').");
        ...
        public static void ViewCompilerLocatedCompiledViews(this ILogger logger, IEnumerable<string> views)
        {
            if (logger.IsEnabled(LogLevel.Debug))
            {
                _viewCompilerLocatedCompiledViews(logger, views.ToArray(), null);
            }
        }
